...
export function Sidebar({ popularArticles }: SidebarProps) {
  return (
    <aside className='w-4/12 p-4 border-l border-[#2d2548]/50'>
      {/* Most Popular */}
      <div className='mb-8'>
        <h3 className='text-lg font-bold text-[#EB1B69] mb-4'>Most Popular</h3>
      ...
      <div className='bg-[#1B1833] rounded-xl p-6 border border-[#2d2548]/50'>
        ...
        <p className='text-sm text-gray-400 mb-4'>Get the latest agent economy news in your inbox.</p>
        <input 
          type='email' 
